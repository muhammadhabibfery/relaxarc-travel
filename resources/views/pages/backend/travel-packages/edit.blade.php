                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="featured_event"
                                        ...
                                        id="featured_event" rows="1">{{ old('featured_event', is_array($travelPackage->featured_event) ? implode(', ', $travelPackage->featured_event) :
                                        $travelPackage->featured_event) }}</textarea>
                                    <small
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="language"
                                        ...
                                        rows="1">{{ old('language', is_array($travelPackage->language) ? implode(', ', $travelPackage->language) :
                                        $travelPackage->language) }}</textarea>
                                    <small
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="foods" class="form-control @error('foods') is-invalid @enderror"
                                        id="foods" rows="1">{{ old('foods', is_array($travelPackage->foods) ? implode(', ', $travelPackage->foods) :
                                        $travelPackage->foods) }}</textarea>
                                    <small
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group flatpickr">
                                        <input type="text" name="date_departure"
                                            ...
                                            placeholder="{{ \Carbon\Carbon::parse(old('date_departure', $travelPackage->date_departure))->translatedFormat('l, d-F-Y H:i') }}"
                                            data-input>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="duration"
                                        ...
                                        value="{{ old('duration', displayEditTravelPackageDuration($travelPackage->duration)) }}">
                                    <small
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control @error('type') is-invalid @enderror"
                                        ...
                                        <option value="Open Trip"
                                            {{ old('type', $travelPackage->type) == 'Open Trip' ? 'selected' : '' }}>
                                            Open Trip</option>
                                        <option value="Private Group"
                                            {{ old('type', $travelPackage->type) == 'Private Group' ? 'selected' : '' }}>
                                            Private Group
                                        </option>
                                    </select>
                                    @error('type')
